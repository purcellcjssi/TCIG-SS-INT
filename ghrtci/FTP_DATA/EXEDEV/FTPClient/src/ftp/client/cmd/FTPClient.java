...
public class FTPClient {
    public static void main(String [] args){
        try {
            String userid = "govofgrenada_trn_ftp";
            String passid = "votzd1XE50eouz6";
            ...
            channelSftp.put("C:\\FTP_Data\\PSDEDUCT.TAB", dest01);
            channelSftp.put("C:\\FTP_Data\\PSEARN.TAB", dest02);
            channelSftp.put("C:\\FTP_Data\\PSEARNDED.TAB", dest03 );
            channelSftp.put("C:\\FTP_Data\\PSNETPAY.TAB", dest04 );
