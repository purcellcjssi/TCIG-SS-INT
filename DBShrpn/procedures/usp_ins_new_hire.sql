...
/*************************************************************************************
   ...
   1.0.01   05/18/2026  CJP                     - Commit Error
    ...
    2.0.00  07/23/2026  CJP                     - Phase I TCIG Changes
                                                    1) Removed variable @emp_calculation as it was not being set and was causing errors in validation U00126 and U00102
                                                    2) Updated Display Name Format code to TCIG's value - needed to generate new individual id
                                                    3) TCIG Country Code - 'TC' - @w_employer_taxing_ctry_code
                                                    4) Currency Code - 'USD'
                                                        - @w_curr_code
...
BEGIN
    ...
    DECLARE @v_DISPLAY_NAME_FORMAT                  char(33)            = 'LNMSFXCOMFNMFMI'   --LNMCOMSFXFNMFMNSMI'  -- Unique to client
    ...
    DECLARE @w_curr_code                            char(03)        = 'USD'     --'XCD'
    ...
    DECLARE @w_user_monetary_curr_code              char(03)        = 'USD'--'XCD'
    ...
    DECLARE @w_empl_addr_fmt_code                   char(06)        = 'GN4'
    ...
    DECLARE @w_employer_taxing_ctry_code            char(02)        = 'TC'      --'LC'
    ...
    DECLARE @w_conv_employment_type_code            char(05)        = @v_EMPTY_SPACE
    ...
    -- CJP 07/23/2026   DECLARE @emp_calculation                    money -- NOT NEEDED Used in validation U00126 and U00102 but variable never set
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            BEGIN TRY
                ...
                IF (@@ROWCOUNT = 0) OR (@w_conv_employment_type_code = @v_EMPTY_SPACE)
                    BEGIN
                        ...
                        -- Populate converted employment type code with empty space to avoid null value in insert statement
                        SET @w_conv_employment_type_code = @v_EMPTY_SPACE
                        ...
                        SET @w_msg_text = 'HCM Code: ' + RTRIM(@employment_type_code) + '; SmartStream: ' + RTRIM(@w_conv_employment_type_code)
                ...
                IF (@birth_date = @v_BAD_DATE_INDICATOR)
                    BEGIN
                        ...
                        EXEC DBShrpn.dbo.usp_ins_ghr_historical_message
                            ...
                            , @p_eff_date           = @eff_date
                            , @p_pay_element_id     = @v_EMPTY_SPACE
                            , @p_msg_p1             = 'Birth date value was not able to be converted to a valid date.'
                            , @p_msg_p2             = ''
                ...
                VALUES('EXECUTE DBShrpn.dbo.usp_ins_hemp')
                    , ('@p_employer_id '                         + '= ' + @v_single_quote + RTRIM(@empl_id)  + @v_single_quote)
                    , (', @p_employee_id '                       + '= ' + @v_single_quote + RTRIM(@emp_id) + @v_single_quote)
                    , (', @p_individual_id '                     + '= ' + @v_single_quote + RTRIM(@ind_idx) + @v_single_quote)
                    , (', @p_original_hire_date '                + '= ' + @v_single_quote + CONVERT(char(8), @eff_date, 112) + @v_single_quote)
                    , (', @p_first_name '                        + '= ' + @v_single_quote + RTRIM(@first_name) + @v_single_quote)
                    , (', @p_first_middle_name '                 + '= ' + @v_single_quote + RTRIM(@first_middle_name) + @v_single_quote)
                    , (', @p_last_name '                         + '= ' + @v_single_quote + RTRIM(@last_name) + @v_single_quote)
                    , (', @p_preferred_name '                    + '= ' + @v_single_quote + RTRIM(@w_preferred_name) + @v_single_quote)
                    , (', @p_name_suffix '                       + '= ' + @v_single_quote + RTRIM(@w_name_suffix) + @v_single_quote)
                    , (', @p_emp_display_name '                  + '= ' + @v_single_quote + RTRIM(@w_emp_display_name) + @v_single_quote)
                    , (', @p_birth_date '                        + '= ' + @v_single_quote + RTRIM(@birth_date) + @v_single_quote)
                    , (', @p_sex_code '                          + '= ' + @v_single_quote + RTRIM(@gender) + @v_single_quote)
                    , (', @p_marital_status_code_1 '             + '= ' + @v_single_quote + RTRIM(@w_marital_status_code_1) + @v_single_quote)
                    , (', @p_national_id_1_type_code '           + '= ' + @v_single_quote + RTRIM(@national_id_type_code) + @v_single_quote)
                    , (', @p_national_id_1 '                     + '= ' + @v_single_quote + RTRIM(@national_id) + @v_single_quote)
                    , (', @p_addr_1_type_code '                  + '= ' + @v_single_quote + RTRIM(@w_addr_1_type_code) + @v_single_quote)
                    , (', @p_addr_1_fmt_code '                   + '= ' + @v_single_quote + RTRIM(@addr_fmt_code) + @v_single_quote)
                    , (', @p_addr_1_line_1 '                     + '= ' + @v_single_quote + RTRIM(@addr_line_1) + @v_single_quote)
                    , (', @p_addr_1_line_2 '                     + '= ' + @v_single_quote + RTRIM(@addr_line_2) + @v_single_quote)
                    , (', @p_addr_1_line_3 '                     + '= ' + @v_single_quote + @v_EMPTY_SPACE + @v_single_quote)
                    , (', @p_addr_1_line_4 '                     + '= ' + @v_single_quote + @v_EMPTY_SPACE + @v_single_quote)
                    , (', @p_addr_1_line_5 '                     + '= ' + @v_single_quote + @v_EMPTY_SPACE + @v_single_quote)
                    , (', @p_addr_1_street_or_pob_1 '            + '= ' + @v_single_quote + RTRIM(@addr_line_3) + @v_single_quote)
                    , (', @p_addr_1_street_or_pob_2 '            + '= ' + @v_single_quote + RTRIM(@addr_line_4) + @v_single_quote)
                    , (', @p_addr_1_street_or_pob_3 '            + '= ' + @v_single_quote + @v_EMPTY_SPACE + @v_single_quote)
                    , (', @p_addr_1_city_name '                  + '= ' + @v_single_quote + RTRIM(@city_name) + @v_single_quote)
                    , (', @p_addr_1_ctry_sub_entity_code '       + '= ' + @v_single_quote + @v_EMPTY_SPACE + @v_single_quote)
                    , (', @p_addr_1_postal_code '                + '= ' + @v_single_quote + RTRIM(@postal_code) + @v_single_quote)
                    , (', @p_addr_1_country_code '               + '= ' + @v_single_quote + RTRIM(@country_code) + @v_single_quote)
                    , (', @p_assigned_to_code '                  + '= ' + @v_single_quote + RTRIM(@w_assigned_to_code) + @v_single_quote)
                    , (', @p_job_or_pos_id '                     + '= ' + @v_single_quote + RTRIM(@w_job_or_pos_id) + @v_single_quote)
                    , (', @p_organization_chart_name '           + '= ' + @v_single_quote + RTRIM(@organization_chart_name) + @v_single_quote)
                    , (', @p_organization_unit_name '            + '= ' + @v_single_quote + RTRIM(@organization_unit_name) + @v_single_quote)
                    , (', @p_emp_status_classn_code '            + '= ' + @v_single_quote + RTRIM(@emp_status_classn_code) + @v_single_quote)
                    ...
                    , (', @p_provided_i_9_ind '                  + '= ' + @v_single_quote + RTRIM(@w_provided_i_9_ind) + @v_single_quote)
                    , (', @p_base_rate_tbl_id '                  + '= ' + @v_single_quote + RTRIM(@w_base_rate_tbl_id) + @v_single_quote)
                    , (', @p_base_rate_tbl_entry_code '          + '= ' + @v_single_quote + RTRIM(@w_base_rate_tbl_entry_code) + @v_single_quote)
                    , (', @p_exception_rate_ind '                + '= ' + @v_single_quote + RTRIM(@w_exception_rate_ind) + @v_single_quote)
                    , (', @p_hourly_pay_rate '                   + '= ' + @v_single_quote + CONVERT(varchar(20), @w_hourly_pay_rate) + @v_single_quote)
                    , (', @p_pd_salary_amt '                     + '= ' + @v_single_quote + CONVERT(varchar(20), @w_pd_salary_amt) + @v_single_quote)
                    , (', @p_pd_salary_tm_pd_id '                + '= ' + @v_single_quote + RTRIM(@w_pd_salary_tm_pd_id) + @v_single_quote)
                    , (', @p_annual_salary_amt '                 + '= ' + @v_single_quote + CONVERT(varchar(20), @w_annual_salary_amt) + @v_single_quote)
                    , (', @p_pay_basis_code '                    + '= ' + @v_single_quote + RTRIM(@w_pay_basis_code) + @v_single_quote)
                    , (', @p_curr_code '                         + '= ' + @v_single_quote + RTRIM(@w_curr_code) + @v_single_quote)
                    , (', @p_work_tm_code '                      + '= ' + @v_single_quote + RTRIM(@w_work_tm_code) + @v_single_quote)
                    , (', @p_standard_daily_work_hrs '           + '= ' + @v_single_quote + CONVERT(varchar(20), @w_standard_daily_work_hrs) + @v_single_quote)
                    , (', @p_standard_work_hrs '                 + '= ' + @v_single_quote + CONVERT(varchar(20), @w_standard_work_hrs) + @v_single_quote)
                    , (', @p_standard_work_pd_id '               + '= ' + @v_single_quote + RTRIM(@w_standard_work_pd_id) + @v_single_quote)
                    , (', @p_overtime_status_code '              + '= ' + @v_single_quote + RTRIM(@w_overtime_status_code) + @v_single_quote)
                    , (', @p_pay_on_reported_hrs_ind '           + '= ' + @v_single_quote + RTRIM(@w_pay_on_reported_hrs_ind) + @v_single_quote)
                    , (', @p_work_shift_code '                   + '= ' + @v_single_quote + RTRIM(@w_work_shift_code) + @v_single_quote)
                    , (', @p_tax_entity_id '                     + '= ' + @v_single_quote + RTRIM(@w_tax_entity_id) + @v_single_quote)
                    , (', @p_time_reporting_meth_code '          + '= ' + @v_single_quote + RTRIM(@time_reporting_meth_code) + @v_single_quote)
                    , (', @p_pay_group_id '                      + '= ' + @v_single_quote + RTRIM(@pay_group_id) + @v_single_quote)
                    , (', @p_clock_nbr '                         + '= ' + @v_single_quote + RTRIM(@w_clock_nbr) + @v_single_quote)
                    , (', @p_prim_disbursal_loc_code '           + '= ' + @v_single_quote + RTRIM(@w_prim_disbursal_loc_code) + @v_single_quote)
                    , (', @p_alt_disbursal_loc_code '            + '= ' + @v_single_quote + RTRIM(@w_alt_disbursal_loc_code) + @v_single_quote)
                    , (', @p_tax_marital_status_code '           + '= ' + @v_single_quote + RTRIM(@w_tax_marital_status_code) + @v_single_quote)
                    , (', @p_fui_status_code '                   + '= ' + @v_single_quote + RTRIM(@w_fui_status_code) + @v_single_quote)
                    , (', @p_oasdi_status_code '                 + '= ' + @v_single_quote + RTRIM(@w_oasdi_status_code) + @v_single_quote)
                    , (', @p_medicare_status_code '              + '= ' + @v_single_quote + RTRIM(@w_medicare_status_code) + @v_single_quote)
                    , (', @p_income_tax_nbr_of_exemps '          + '= ' + @v_single_quote + CONVERT(varchar(20), @w_income_tax_nbr_of_exemps) + @v_single_quote)
                    , (', @p_tax_authority_id '                  + '= ' + @v_single_quote + RTRIM(@w_tax_authority_id) + @v_single_quote)
                    , (', @p_work_resident_status_code '         + '= ' + @v_single_quote + RTRIM(@w_work_resident_status_code) + @v_single_quote)
                    , (', @p_income_tax_calc_meth_cd '           + '= ' + @v_single_quote + RTRIM(@w_income_tax_calc_meth_cd) + @v_single_quote)
                    , (', @p_tax_authority_2 '                   + '= ' + @v_single_quote + RTRIM(@w_tax_authority_2) + @v_single_quote)
                    , (', @p_tax_authority_3 '                   + '= ' + @v_single_quote + RTRIM(@w_tax_authority_3) + @v_single_quote)
                    , (', @p_tax_authority_4 '                   + '= ' + @v_single_quote + RTRIM(@w_tax_authority_4) + @v_single_quote)
                    , (', @p_tax_authority_5 '                   + '= ' + @v_single_quote + RTRIM(@w_tax_authority_5) + @v_single_quote)
                    , (', @p_work_resident_status_code_2 '       + '= ' + @v_single_quote + RTRIM(@w_work_resident_status_code_2) + @v_single_quote)
                    , (', @p_work_resident_status_code_3 '       + '= ' + @v_single_quote + RTRIM(@w_work_resident_status_code_3) + @v_single_quote)
                    , (', @p_work_resident_status_code_4 '       + '= ' + @v_single_quote + RTRIM(@w_work_resident_status_code_4) + @v_single_quote)
                    , (', @p_work_resident_status_code_5 '       + '= ' + @v_single_quote + RTRIM(@w_work_resident_status_code_5) + @v_single_quote)
                    , (', @p_user_amt_1 '                        + '= ' + @v_single_quote + CONVERT(varchar(20), @w_user_amt_1) + @v_single_quote)
                    , (', @p_user_amt_2 '                        + '= ' + @v_single_quote + CONVERT(varchar(20), @w_user_amt_2) + @v_single_quote)
                    , (', @p_user_code_1 '                       + '= ' + @v_single_quote + RTRIM(@w_user_code_1) + @v_single_quote)
                    , (', @p_user_code_2 '                       + '= ' + @v_single_quote + RTRIM(@w_user_code_2) + @v_single_quote)
                    , (', @p_user_date_1 '                       + '= ' + @v_single_quote + RTRIM(@w_user_date_1) + @v_single_quote)
                    , (', @p_user_date_2 '                       + '= ' + @v_single_quote + RTRIM(@w_user_date_2) + @v_single_quote)
                    , (', @p_user_ind_1 '                        + '= ' + @v_single_quote + RTRIM(@w_user_ind_1) + @v_single_quote)
                    , (', @p_user_ind_2 '                        + '= ' + @v_single_quote + RTRIM(@w_user_ind_2) + @v_single_quote)
                    , (', @p_user_monetary_amt_1 '               + '= ' + @v_single_quote + CONVERT(varchar(20), @w_user_monetary_amt_1) + @v_single_quote)
                    , (', @p_user_monetary_amt_2 '               + '= ' + @v_single_quote + CONVERT(varchar(20), @w_user_monetary_amt_2) + @v_single_quote)
                    , (', @p_user_monetary_curr_code '           + '= ' + @v_single_quote + RTRIM(@w_user_monetary_curr_code) + @v_single_quote)
                    , (', @p_user_text_1 '                       + '= ' + @v_single_quote + RTRIM(@w_user_text_1) + @v_single_quote)
                    , (', @p_user_text_2 '                       + '= ' + @v_single_quote + RTRIM(@position_title) + @v_single_quote)
                    , (', @p_inc_tax_calc_method '               + '= ' + @v_single_quote + RTRIM(@w_inc_tax_calc_method) + @v_single_quote)
                    , (', @p_ei_status_code '                    + '= ' + @v_single_quote + RTRIM(@w_ei_status_code) + @v_single_quote)
                    , (', @p_ppip_status_code '                  + '= ' + @v_single_quote + RTRIM(@w_ppip_status_code) + @v_single_quote)
                    , (', @p_fed_pp_stat_code '                  + '= ' + @v_single_quote + RTRIM(@w_fed_pp_stat_code) + @v_single_quote)
                    , (', @p_provincial_pp_stat_code '           + '= ' + @v_single_quote + RTRIM(@w_provincial_pp_stat_code) + @v_single_quote)
                    , (', @p_income_tax_stat_code '              + '= ' + @v_single_quote + RTRIM(@w_income_tax_stat_code) + @v_single_quote)
                    , (', @p_pit_stat_code '                     + '= ' + @v_single_quote + RTRIM(@w_pit_stat_code) + @v_single_quote)
                    , (', @p_pay_element_ctrl_grp '              + '= ' + @v_single_quote + RTRIM(@pay_element_ctrl_grp_id) + @v_single_quote)
                    , (', @p_emp_workers_comp_class '            + '= ' + @v_single_quote + RTRIM(@w_emp_workers_comp_class) + @v_single_quote)
                    , (', @p_empl_addr_fmt_code '                + '= ' + @v_single_quote + RTRIM(@w_empl_addr_fmt_code) + @v_single_quote)
                    , (', @p_empl_phone_fmt_code '               + '= ' + @v_single_quote + RTRIM(@w_empl_phone_fmt_code) + @v_single_quote)
                    , (', @p_empl_phone_delimiter '              + '= ' + @v_single_quote + RTRIM(@w_empl_phone_delimiter) + @v_single_quote)
                    , (', @p_empl_recruitment_zone_code '        + '= ' + @v_single_quote + RTRIM(@w_empl_recruitment_zone_code) + @v_single_quote)
                    , (', @p_empl_cma_code '                     + '= ' + @v_single_quote + RTRIM(@w_empl_cma_code) + @v_single_quote)
                    , (', @p_empl_industry_sector_code '         + '= ' + @v_single_quote + RTRIM(@w_empl_industry_sector_code) + @v_single_quote)
                    , (', @p_empl_province_terr_code '           + '= ' + @v_single_quote + RTRIM(@w_empl_province_terr_code) + @v_single_quote)
                    , (', @p_eeo_4_agency_function_code '        + '= ' + @v_single_quote + RTRIM(@w_eeo_4_agency_function_code) + @v_single_quote)
                    , (', @p_eeo_establishment_id '              + '= ' + @v_single_quote + RTRIM(@w_eeo_establishment_id) + @v_single_quote)
                    , (', @p_assignment_end_date '               + '= ' + @v_single_quote + RTRIM(@w_assignment_end_date) + @v_single_quote)
                    , (', @p_location_code '                     + '= ' + @v_single_quote + RTRIM(@w_location_code) + @v_single_quote)
                    , (', @p_salary_structure_id '               + '= ' + @v_single_quote + RTRIM(@w_salary_structure_id) + @v_single_quote)
                    , (', @p_salary_incr_guideline_id '          + '= ' + @v_single_quote + RTRIM(@w_salary_incr_guideline_id) + @v_single_quote)
                    , (', @p_pay_grade_code '                    + '= ' + @v_single_quote + RTRIM(@w_pay_grade_code) + @v_single_quote)
                    , (', @p_job_evaluation_points_nbr '         + '= ' + @v_single_quote + CONVERT(varchar(20), @w_job_evaluation_points_nbr) + @v_single_quote)
                    , (', @p_salary_step_nbr '                   + '= ' + @v_single_quote + CONVERT(varchar(20), @w_salary_step_nbr) + @v_single_quote)
                    , (', @p_employer_taxing_ctry_code '         + '= ' + @v_single_quote + RTRIM(@w_employer_taxing_ctry_code) + @v_single_quote)
                    , (', @p_organization_group_id '             + '= ' + @v_single_quote + RTRIM(@organization_group_id) + @v_single_quote)
                    , (', @p_wage_plan_code '                    + '= ' + @v_single_quote + RTRIM(@w_wage_plan_code) + @v_single_quote)
                    , (', @p_emp_health_insurance_cvg_cd '       + '= ' + @v_single_quote + RTRIM(@w_emp_health_insurance_cvg_cd) + @v_single_quote)
                    , (', @p_tax_auth_type_code '                + '= ' + @v_single_quote + RTRIM(@w_tax_auth_type_code) + @v_single_quote)
                    , (', @p_tax_auth_type_code_2 '              + '= ' + @v_single_quote + RTRIM(@w_tax_auth_type_code_2) + @v_single_quote)
                    , (', @p_tax_auth_type_code_3 '              + '= ' + @v_single_quote + RTRIM(@w_tax_auth_type_code_3) + @v_single_quote)
                    , (', @p_tax_auth_type_code_4 '              + '= ' + @v_single_quote + RTRIM(@w_tax_auth_type_code_4) + @v_single_quote)
                    , (', @p_tax_auth_type_code_5 '              + '= ' + @v_single_quote + RTRIM(@w_tax_auth_type_code_5) + @v_single_quote)
                    , (', @p_reg_reporting_unit_code '           + '= ' + @v_single_quote + RTRIM(@w_reg_reporting_unit_code) + @v_single_quote)
                    , (', @p_emp_workers_comp_cvg_cd '           + '= ' + @v_single_quote + RTRIM(@w_emp_workers_comp_cvg_cd) + @v_single_quote)
                    , (' ');
